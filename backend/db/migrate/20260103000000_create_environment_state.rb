...
class CreateEnvironmentState < ActiveRecord::Migration[7.1]
  def change
    create_table :environment_records, id: false do |t|
    ...
    execute 'ALTER TABLE environment_records ADD PRIMARY KEY (id)' if connection.adapter_name.downcase.include?('postgres')
